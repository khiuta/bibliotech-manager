        ...
        <div className="flex w-full h-[45%]  p-10 justify-center">
          <div className="flex flex-col bg-[#2B2B2B] w-[90%] rounded-2xl">
            <section className="flex w-full h-[35%]  items-end justify-around p-6">
              <input
                className="flex bg-[#191919] w-[80%] h-[100%] rounded-2xl p-4 text-xl focus: outline-none"
                placeholder="Digite suas anotações aqui..."
              />
              <div className="flex h-[100%] bg-[#191919] p-4 rounded-2xl items-center">
                <IoIosAddCircleOutline size={40} />
              </div>
            </section>
            <section className="flex w-full h-[65%] p-4 justify-around">
              <div className="flex bg-[#191919] w-[80%] h-[30%] rounded-2xl p-4 text-xl focus: outline-none"></div>
